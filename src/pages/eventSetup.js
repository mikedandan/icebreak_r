...
export default class Signup extends Component {
  ...
  generateEvent = async () => {
    ...
    //http://10.0.2.2:3000/
    axios
      .post('https://icebreakr-serv.herokuapp.com/api/event/newevent', {
        eventName: this.state.eventName,
        eventLocation: this.state.eventLocation,
        lat: this.state.lat,
        lng: this.state.lng,
      ...
      .then(function (response) {
        ...
        axios
          .post(
            'https://icebreakr-serv.herokuapp.com/api/message/new',
            newMessage,
          )
          .then(function (response) {
            console.log('YIKESSS')
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                Your event chat will be specific to your event. Only people with
                your event ID will be able to join your event
              </Text>
              <Button info style={styles.button}>
                <Text
                  style={{ fontSize: 20, color: 'white', textAlign: 'center' }}
                  onPress={() => this.generateEvent()}>
                  SETUP EVENT
                </Text>
              </Button>
            </View>
